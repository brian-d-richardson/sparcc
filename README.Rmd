...
The workflow used to analyze the ENROLL-HD dataset in the accompanying paper is replicated in the folder `fake_data_analysis/`, but using synthetic data. Details and a data dictionary are provided in `fake_data_analysis/00-FakeData-Dictionary.Rmd`.
