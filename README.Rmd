...
We then compare estimates. Note that the MLE estimates are far from the truth,. which sense since the MLE is inconsistent under a misspecified model for $X|Z$.
...
Finally, we can compute standard errors for the different estimators based on influence function variance estimators. For the MLE, this type of variance estimation is not valid and so is not included.
