...
make.est.plot <- function(param., n. = 10000, est_cutoff = Inf) {
  ...
  sim.out.long %>% 
    ...
    labs(y = "Parameter Estimate",
         fill = "Method") +
    ggtitle(paste0("Empirical Distribution of Parameter Estimates for Beta",
                   param.),
...
make.est.plot(param. = 1, n. = 10000, est_cutoff = 2)
...
* Extend the model to include a (discrete) uncensored covariate $Z$ and allow $Y|X,Z$ to have unknown variance $\sigma^2$.
